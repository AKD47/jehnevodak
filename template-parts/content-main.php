...
<article id="post-<?php the_ID(); ?>" <?php post_class('main'); ?>>
        ...
        <div class="about__wrapper">
            <div class="about__left">
                ...
                <p>To, co jste nám sdělili pro potřeby výkonu naší činnosti zůstavá striktně uzamčeno v naší kanceláři.
                    Mlčenlivosti nás můžete zprostit jenom Vy. Vážíme si důvěry, se kterou se na nás obracíte a
                    nezklameme Vás.</p>
                ...
                <p>Nečiníme rozdíl mezi malými a velkými případy. Jsme přesvědčení, že klient, který se na nás obrátil a
                    ...
                    komplikovaných případech podléhají tyto výstupy ještě závěrečné kontrole ze strany vedoucího
                    advokáta nebo partnera kanceláře.</p>
            </div>
            <div class="about__right">
                <h3>Naprostá spolehlivost</h3>
                <p>Váš email či telefon nezůstane bez reakce. Termíny, na kterých jsme se dohodli striktně dodržujeme.
                    To, co jsme slíbili, rovněž splníme. Nenecháme Vás nikdy bez naší právní podpory.</p>
                <h3>Efektivita</h3>
                <p>Vždy hledáme co možná nejjednodušší a nejrychlejší cestu k vyřešení Vašeho problému. Kromě osobních
                    schůzek řešíme jednotlivé kauzy také emailem či telefonicky. Počet našich advokátů umožňuje
                    vzájemnou zastupitelnost a eliminuje riziko průtahů při řešení Vašich problémů.</p>
            </div>
    ...
    <section id="attent" class="attent">
        ...
        <div class="attent__element">
            <div class="photo"><img src="<?php bloginfo('template_directory'); ?>/assets/img/att-1.png" alt="photo">
            </div>
            <div class="descr">
                <div class="triangle"></div>
                <h3>Právo obchodních korporací, fúze a akvizice</h3>
                <p>Advokátní kancelář Jehne, Vodák a partneří je již více než 15 let spolehlivým partnerem klientům z
                    řad středních a středně velkých podnikatelských subjektů, osobám fyzickým i právnickým, a to ve
                    všech zásadních oblastech práva. Na rozdíl od některých jiných advokátních kanceláří partneři a
                    vlastníci kanceláře advokacii aktivně vykonávají a přebírají tak za služby, poskytované kanceláří,
                    plnou odpovědnost. Všichni právníci naší advokátní kanceláře mají vysokoškolské vzdělání právnického
                    směru a jsou řádně registrováni u České advokátní komory.</p>
                <p>Právní služby, poskytované naší advokátní kanceláří vycházejí z bezpodmínečně perfektní znalosti
                    platného práva a aktuální tuzemské i zahraniční judikatury. Naši právníci těmito znalostmi
                    disponují a průběžně je dle vývoje právní úpravy aktualizují.</p>
                <p>Právní služby, poskytované naší advokátní kanceláří vycházejí z bezpodmínečně perfektní znalosti
                    platného práva a aktuální tuzemské i zahraniční judikatury. Naši právníci těmito znalostmi
                    disponují a průběžně je dle vývoje právní úpravy aktualizují.</p>
            </div>
        ...
        <div class="attent__element">
            <div class="descr">
                ...
                <p>Advokátní kancelář Jehne, Vodák a partneří je již více než 15 let spolehlivým partnerem klientům z
                    ...
                    směru a jsou řádně registrováni u České advokátní komory.</p>
                <p>Právní služby, poskytované naší advokátní kanceláří vycházejí z bezpodmínečně perfektní znalosti
                    platného práva a aktuální tuzemské i zahraniční judikatury. Naši právníci těmito znalostmi disponují
                    a průběžně je dle vývoje právní úpravy aktualizují.</p>
                <p>Právní služby, poskytované naší advokátní kanceláří vycházejí z bezpodmínečně perfektní znalosti
                    platného práva a aktuální tuzemské i zahraniční judikatury. Naši právníci těmito znalostmi disponují
                    a průběžně je dle vývoje právní úpravy aktualizují.</p>
            </div>
            <div class="photo"><img src="<?php bloginfo('template_directory'); ?>/assets/img/att-2.png" alt="photo">
            </div>
        </div>
        <div class="attent__element">
            <div class="photo"><img src="<?php bloginfo('template_directory'); ?>/assets/img/att-3.png" alt="photo">
            </div>
            <div class="descr">
                <div class="triangle"></div>
        ...
        <div class="attent__element">
            ...
            <div class="photo"><img src="<?php bloginfo('template_directory'); ?>/assets/img/att-4.png" alt="photo">
            </div>
        </div>
        <div class="attent__element">
            <div class="photo"><img src="<?php bloginfo('template_directory'); ?>/assets/img/att-5.png" alt="photo">
            </div>
            <div class="descr">
                <div class="triangle"></div>
        ...
        <div class="attent__element">
            ...
            <div class="photo"><img src="<?php bloginfo('template_directory'); ?>/assets/img/att-6.png" alt="photo">
            </div>
        </div>
        <div class="attent__element">
            <div class="photo"><img src="<?php bloginfo('template_directory'); ?>/assets/img/att-7.png" alt="photo">
            </div>
            <div class="descr">
                <div class="triangle"></div>
                <h3>Právo IT</h3>
        ...
        <div class="attent__element">
            ...
            <div class="photo"><img src="<?php bloginfo('template_directory'); ?>/assets/img/att-8.png" alt="photo">
            </div>
        </div>
    </section>
